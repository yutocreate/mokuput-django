...
class App extends Component {
  ...
  handleSubmit(event) {
    ...
    axios
      .post("http://localhost:8000/api/profile/?format=json", conf)
      .then((response) => {
  ...
  componentDidMount() {
    axios
      .get("http://localhost:8000/api/profile/?format=json")
      .then((response) => {
        this.setState({
    ...
    return (
      <div className="columns is-multiline">
        <div className="column is-6">
          <div className="notification">This is my react-django app.</div>
        </div>
        <div className="column is-6">
          <Form
